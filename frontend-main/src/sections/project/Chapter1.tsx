...
export default function Chapter1() {
  ...
  const text1 = (
    <>
      ...
      이러한 효능은 인삼 속의 사포닌 성분인 진세노사이드(ginsenosides)로부터 유래된다. 진세노사이드는 배당체 형태를 띠며,
      ...
      함량을 향상시키는 연구가 진행되고 있다. 이를 위해 산처리, 가열, 합성, 미생물발효, 효소 등을 활용한 기술이 개발되고 있다.
    </>
  );
  ...
  const text2 = (
    <>
      ...
      minor 진세노사이드가 생성된다. 산 또는 알칼리를 이용하는 방법은 당을 무작위로 가수분해시켜 산성 다당체와
  ...
  return (
    <div css={ChapterContainerCSS}> {/* ✅ 배경 이미지 적용된 스타일 사용 */}
      <p css={ChapterTitleCSS}>한국장인인삼의 효능</p>
