    ...
    <div>
      ...
      <div css={TopMessageCSS}>
        ...
        <p css={TopMessageHighlightCSS}>
          신체면역기능향상, 항산화효과, 당뇨개선, 혈압안정, 항암효과,
          남성성기능향상
        </p>
        <p css={TopMessageLastCSS}>여성갱년기증상완화 등 프리미엄 제품</p>
      </div>
      ...
      <div css={ContainerCSS}>
        ...
        <div css={TextFlexCSS}>
          ...
          <p css={DescriptionCSS}>
            <br />
            4~6년근에서 추출가능한 진세노사이드 함량은 24ml까지 고농축 추출,
            RG3함량은 70% 이상 RG3는 예로부터 항암효과, 노화방지,
            갱년기증상완화, 면역증진, 원기회복, 치매예방, 혈행개선, 성기능향상,
            당뇨개선, 혈압안정 등 동의보감에서는 만병통치약으로도 불려진다.
          </p>
        </div>
      </div>
    </div>
