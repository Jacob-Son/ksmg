  ...
  return (
    <ModalPortal>
      ...
      <div css={ModalBodyCSS}>
        ...
        <p css={ModalTitleCSS}>새 상품 등록 안내</p>
        <p css={[ModalTextCSS, css({ marginTop: 20 })]}>
          [작성안내]
          <br />
          모든 회원이 쾌적하고 안전하게 서비스를 이용할 수 있도록 상품을
          작성하실 때 아래 사항을 지켜주세요.
        </p>
        <ol css={WarningListCSS}>
          <li>
            저작권 등 다른 사람의 권리를 침해하거나 명예를 훼손하는 상품 혹은
            에피소드는 피카펜 이용약관 및 법률에 따라 제재를 받을 수 있습니다.
          </li>
          <li>
            아래 요소가 포함된 상품은 별도의 경고나 사전 통보없이 비공개 및 삭제
            처리될 수 있습니다.
            <br />- 비방, 욕설, 명예훼손
            <br />- 폭력, 비행 조장
            <br />- 음란물, 청소년 유해물, 성인물
          ...
          <li>
            피카펜은 등록된 상품이 다른 회원들에게 피해를 주지 않도록 엄격하게
          ...
          <li>
            상품 판매 시 플랫폼 수수료(3%) 부과됩니다. 플랫폼 수수료는 변동
            가능합니다.
          </li>
          <li>
